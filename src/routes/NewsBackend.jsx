    ...
    <div>
      <section className="backend-page">
        ...
        <div className="backendDesktopImg">
          <img
            src={backendImg}
            alt="Desktop view of the code used for the API"
          />
        </div>
        <p>
          This project which i did my time at Northcoders demonstrates my
          ability to build a RESTful API backend in just 5 days. I used
          JavaScript and Express.js to create an API that interacts with a
          PostgreSQL database, showcasing my backend development skills.
        </p>
